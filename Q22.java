/*
Q22.Check Digits. Credit cards usually have a so-called check digit. This is a single digit that I assigned when the 
...
public class DigitCheck {
        ...
        public static void main(String[] args) {
            ...
            System.out.print(sumDoubleEven(num) + sumodd(num));
